      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Link href="/admin/dashboard/courses">
            <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 cursor-pointer border-2 border-transparent hover:border-purple-500">
              <div className="flex items-center justify-between mb-6">
                <div className="w-16 h-16 bg-gradient-to-br from-purple-500 to-purple-700 rounded-full flex items-center justify-center">
                  <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 10l4.553-2.069A1 1 0 0121 8.87v6.26a1 1 0 01-1.447.894L15 14M3 8h12a2 2 0 012 2v4a2 2 0 01-2 2H3a2 2 0 01-2-2v-4a2 2 0 012-2z"></path>
                  </svg>
                </div>
              ...
              <h3 className="font-orbitron text-2xl font-bold text-gray-900 mb-2">Courses</h3>
              <p className="text-gray-600">Manage video courses, upload lessons, and set the intro video</p>
              <div className="mt-6 pt-6 border-t border-gray-200">
                <p className="text-sm text-gray-500">Video lessons, pricing, and student access</p>
              </div>
            </div>
          </Link>
          {/* Shop Management */}
          ...
          <Link href="/admin/dashboard/students">
            <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 cursor-pointer border-2 border-transparent hover:border-green-500">
              <div className="flex items-center justify-between mb-6">
              ...
              <h3 className="font-orbitron text-2xl font-bold text-gray-900 mb-2">Students</h3>
              <p className="text-gray-600">View all students and manually grant or revoke course access</p>
              <div className="mt-6 pt-6 border-t border-gray-200">
                <p className="text-sm text-gray-500">Manage course access without payment</p>
              </div>
            </div>
          </Link>
