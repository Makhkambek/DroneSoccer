...
export default function Lessons() {
      ...
      fetch('/api/purchases')
        ...
        .then((data) => {
          if (Array.isArray(data)) {
            setPurchasedIds(data.map((p: { courseId: string }) => p.courseId));
          }
        })
        .catch(() => {});
    }
  ...
  const otherCourses = courses.filter((c) => !purchasedIds.includes(c.id));
  ...
  return (
    <div className="pt-20">
      ...
      {/* My Courses Section */}
      {status !== 'loading' && myCourses.length > 0 && (
        <section className="py-16 bg-blue-50 border-b border-blue-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center space-x-3 mb-10">
              ...
              <h2 className="font-orbitron text-2xl font-bold text-gray-800">My Courses</h2>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {myCourses.map((course) => (
                <div
                  key={course.id}
                  className="bg-white rounded-2xl shadow-xl overflow-hidden border-2 border-primary-blue"
                >
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        <div className="flex items-center space-x-3 mb-2">
                          ...
                          <span className="px-3 py-1 bg-white rounded-full text-sm font-bold text-primary-blue">
                            Purchased
                          </span>
                        </div>
                        <h3 className="font-orbitron text-3xl font-bold mb-2">{course.title}</h3>
                        <p className="text-white/90 text-lg font-semibold">{course.subtitle}</p>
                      </div>
                  ...
                  <div className="p-8">
                    <h4 className="font-orbitron font-bold text-xl mb-4 text-gray-800">What You'll Learn</h4>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="section-heading">{myCourses.length > 0 ? 'Other Courses' : 'Our Courses'}</h2>
          ...
          {otherCourses.length === 0 ? (
            <p className="text-center text-gray-500 text-lg">You have enrolled in all available courses!</p>
          ) : (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="section-subheading">World-class training facilities and expert instructors</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed">Learn from professional pilots with years of competitive experience and teaching expertise.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed">Train in professional-grade arenas with the latest equipment and safety features.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed">Receive official certification upon course completion, recognized internationally.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-r from-primary-blue to-primary-red">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="font-orbitron text-4xl md:text-5xl font-bold text-white mb-6">Ready to Start Learning?</h2>
          <p className="text-xl text-white/90 mb-8">Take the first step towards becoming a professional drone pilot</p>
          <Link
            href="/apply"
